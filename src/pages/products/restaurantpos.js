...
<section>
  ...
  <p>
    <strong>WINHUB POS</strong>&nbsp;is an online restaurant Point of Sale app
    has a user friendly interface that everyone can use without difficulty. The
    POS can be used online, on iPads, Android tablets or laptops
    <br />
    Say goodbye to ugly, expensive, outdated POS systems and enjoy the WINHUB
    POS web interface designed for the modern retailer.
  </p>
  <p>&nbsp;</p>
  <h4>
    <img
  ...
  >
    ...
    <li>
      Discount (you can add a spesific discount for every customer OR a discount
      for each sale)
    </li>
    <li>
      Reports (customers, product number) (monthly stats in the current or other
      years) … etc
    </li>
    <li>Clients or products repprot in a specific Range.</li>
    <li>Barcode scanner compatible (for the products and sales receipt)</li>
    <li>Print and save receipts</li>
    <li>Hold sales option</li>
    <li>On-Screen Keyboard (you enables or disabled in the setting page)</li>
